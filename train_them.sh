...
python hierarchy_trainer_simple_v3.py default --hierarchy_path ./results/simple_trainer_original/garden_type_colmap_factor_8/ply/point_cloud_29999_hierarchy/hierarchy.pt --data_dir ./dataset/360_v2/garden/ --data_factor 8 --use_coarse_to_fine
python hierarchy_trainer_simple_v2.py default --hierarchy_path ./results/simple_trainer_original/garden_type_colmap_factor_8/ply/point_cloud_29999_hierarchy/hierarchy.pt --data_dir ./dataset/360_v2/garden/ --data_factor 8 --use_coarse_to_fine
python hierarchy_trainer_simple.py default --hierarchy_path ./results/simple_trainer_original/garden_type_colmap_factor_8/ply/point_cloud_29999_hierarchy/hierarchy.pt --data_dir ./dataset/360_v2/garden/ --data_factor 8 --use_coarse_to_fine --hierarchy_consistency_lambda 0.0
