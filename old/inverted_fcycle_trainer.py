...
class Config:
    ...
    # Inverted F-cycle parameters
    smoothing_steps: int = 100  # Number of smoothing steps per level
    solving_steps: int = 100  # Number of solving steps at coarsest level
    ...
    def __post_init__(self):
        ...
        if self.result_dir is None:
            ...
            self.result_dir = f"/Bean/log/gwangjin/2025/gsplat/inv_fcycle/{dataset_name}_{settings_str}"
