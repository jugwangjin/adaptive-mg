...
from multigrid_gaussians_v6 import MultigridGaussians, quaternion_multiply
...
class Config:
    ...
    def __post_init__(self):
        ...
        if self.result_dir is None:
            ...
            self.result_dir = f"/Bean/log/gwangjin/2025/gsplat/vcycle_trainer_v14_{self.cycle_type}/{dataset_name}_{settings_str}_v1"
...
def vcycle_recursive(
    ...
    if level > coarsest_level:
        coarse_level = level - 1
        prolongation_steps = max(1, current_smoothing_steps // 2)
