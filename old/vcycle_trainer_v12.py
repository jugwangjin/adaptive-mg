...
class Config:
    ...
    def __post_init__(self):
        ...
        if self.result_dir is None:
            ...
            self.result_dir = f"/Bean/log/gwangjin/2025/gsplat/vcycle_trainer_v12_{self.cycle_type}/{dataset_name}_{settings_str}_v2"
...
def vcycle_recursive(
    ...
    if level > coarsest_level:
        ...
        for data in down_smoothing_views:
            ...
            restriction_loss = relation_loss + gt_loss
            ...
            del fine_colors, fine_render_downsampled, coarse_colors, fine_pixels_downsampled, coarse_pixels_downsampled, fine_alphas, coarse_alphas
            torch.cuda.empty_cache()
    ...
    if level > coarsest_level:
        ...
        for data in down_smoothing_views:
            ...
            prolongation_loss = relation_loss + gt_loss
            ...
            # Free intermediate tensors
            del coarse_colors, fine_colors, fine_render_downsampled, fine_pixels_downsampled, coarse_pixels_downsampled, fine_alphas, coarse_alphas
            torch.cuda.empty_cache()
