...
class MultigridStrategy(Strategy):
    ...
    n_children_per_split: int = 5  # Number of children to create per split
    ...
    def _grow_gs(
        ...
        for level in range(coarsest_level, finest_level + 1):
            ...
            # Only signal if parent is not already densified
        ...
        # Reset grad2d for all densified gaussians BEFORE densification to prevent excessive densification
        # This is simpler than tracking indices after densification
        if "grad2d" in state and (n_dupli > 0 or n_split > 0 or n_create_children > 0):
